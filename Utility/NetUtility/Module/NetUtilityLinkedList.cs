...
public sealed class NetUtilityLinkedList<T> : ICollection<T>, ICollection
{
    ...
    public void RemoveFirst()
    {
        ...
        if (first == null) throw new NetUtilityException("First is invalid.");
    ...
    public void RemoveLast()
    {
        ...
        if (last == null) throw new NetUtilityException("Last is invalid.");
    ...
    public struct Enumerator : IEnumerator<T>, IEnumerator
    {
        ...
        {
            if (linkedList == null) throw new NetUtilityException("Linked list is invalid.");
