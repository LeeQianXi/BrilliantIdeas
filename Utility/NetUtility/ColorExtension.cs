...
public static class ColorExtension
{
    extension(string color)
    {
        ...
        public Color StringColorToColor()
        {
            return color.StringColorToArgbInt().ArgbIntToColor();
        }
        ...
        public Color StringToColor()
        {
            ...
            return color.StartsWith("#") ? color.StringColorToColor() : Color.FromName(color);
        }
        ...
        public int StringToArgbInt()
        {
            if (string.IsNullOrEmpty(color))
                throw new ArgumentException("颜色字符串不能为空");
            return (color.StartsWith("#") ? color.StringColorToColor() : Color.FromName(color)).ToArgb();
        }
    }
    ...
    extension(int argb)
    {
        ...
        public Color ArgbIntToColor()
        {
            var (a, r, g, b) = argb.GetColorComponents();
