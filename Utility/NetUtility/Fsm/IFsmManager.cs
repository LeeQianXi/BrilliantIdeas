...
{
    public static IFsmManager Instance => Internal._instance;
    ...
    void GetAllFsms(out List<FsmBase> results);
    ...
    private static class Internal
    {
        ...
        public static readonly IFsmManager _instance = new FsmManager();
    }
}