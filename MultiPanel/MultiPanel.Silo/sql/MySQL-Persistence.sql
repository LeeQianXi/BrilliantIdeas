...
ALTER TABLE OrleansStorage
    ADD INDEX IX_OrleansStorage (GrainIdHash, GrainTypeHash);
...
END;
    ...
    SET
_newGrainStateVersion = _GrainStateVersion;
...
WHERE GrainIdHash = _GrainIdHash
  ...
  AND _GrainStateVersion IS NOT NULL LIMIT 1;
...
ROW_COUNT() > 0
        THEN
            SET _newGrainStateVersion = _GrainStateVersion + 1;
            SET
_GrainStateVersion = _newGrainStateVersion;
END IF;
END IF;
          ...
          (
              ...
              WHERE GrainIdHash = _GrainIdHash
                ...
                AND ((_GrainIdExtensionString IS NOT NULL AND GrainIdExtensionString IS NOT NULL AND
                     ...
                     _GrainIdExtensionString IS NULL AND GrainIdExtensionString IS NULL)
                AND ServiceId = _ServiceId
                AND _ServiceId IS NOT NULL) LIMIT 1;
